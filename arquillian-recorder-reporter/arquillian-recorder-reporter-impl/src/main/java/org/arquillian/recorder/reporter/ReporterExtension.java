...
public class ReporterExtension implements LoadableExtension {
    ...
    public void register(ExtensionBuilder builder) {
        ...
        builder.observer(ReporterLifecycleObserver.class);
        builder.observer(ExporterObserver.class);
        builder.observer(ReporterExtensionInitializer.class);
        builder.observer(ExporterRegistrationHandler.class);
    }
