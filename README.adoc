...
Please note that this is meant to be used from your own Arquillian extension and it is not supposed to be used directly it test class itself. Eventing and injecting as shown below is not JavaEE eventing. It is Arquillian's own eventing and injecting model you have to embed into your own Arquillian extension in order to report something. In case you want other resource to report besides what is ready for you https://github.com/arquillian/arquillian-recorder/tree/master/arquillian-recorder-reporter/arquillian-recorder-reporter-api/src/main/java/org/arquillian/recorder/reporter/model/entry[like here], send a PR or contact owner of this repository in order to implement that.
