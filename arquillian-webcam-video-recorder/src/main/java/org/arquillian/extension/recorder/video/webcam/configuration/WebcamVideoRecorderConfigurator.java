 ...
 */
public class WebcamVideoRecorderConfigurator extends VideoConfigurator {

    private static final Logger logger = Logger.getLogger(WebcamVideoRecorderConfigurator.class.getSimpleName());
    ...
    public void afterVideoExtensionConfigured(@Observes VideoExtensionConfigured event, ArquillianDescriptor descriptor) {
        VideoConfiguration configuration = new WebcamVideoConfiguration(reporterConfiguration.get());
