 ...
 *
 */
public class WebcamVideoRecorder implements Recorder {
     ...
     *
     */
    public WebcamVideoRecorder(TakenResourceRegister takenResourceRegister) {
    ...
    public void init(VideoConfiguration configuration) {
        if (this.configuration == null) {
            if (configuration != null) {
                ...
                recorder = new WebcamRecorder((WebcamVideoConfiguration) this.configuration);
            }
        }
    }
