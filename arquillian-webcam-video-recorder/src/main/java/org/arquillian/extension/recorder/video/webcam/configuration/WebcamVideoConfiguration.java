 ...
 *
 */
public class WebcamVideoConfiguration extends VideoConfiguration {

    private static Logger logger = Logger.getLogger(WebcamVideoConfiguration.class.getSimpleName());

    private String frameRate = "20"; // fps

    public WebcamVideoConfiguration(ReporterConfiguration reporterConfiguration) {
